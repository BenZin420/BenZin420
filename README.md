        ...
        <div class="position-relative">
                    ...
                    <div class="row">
                        <div class="col-7 col-md-4">
                            <a href="index.html" class="tm-bg-black text-center tm-logo-container">
                                <i ></i>
                                <h1 class="tm-site-name">Como pelar papa correctamente</h1>
                            </a>
                        </div>
                                    ...
                                    <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                                        <ul class="navbar-nav text-uppercase">
                                            <li class="nav-item active">
                                                <a class="nav-link tm-nav-link" href="#">Patataa <span class="sr-only"> hervida </span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link tm-nav-link" href="about.html">papas</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link tm-nav-link" href="contact.html">mas papas</a>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
            ...
            <div class="tm-welcome-container text-center text-white">
                <div class="tm-welcome-container-inner">
                    <p class="tm-welcome-text mb-1 text-white">La papa papá del papa que es papa</p>
                    <p class="tm-welcome-text mb-5 text-white">patataaaaa</p>
